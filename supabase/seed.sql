...
-- ============================================================
-- AXION: remove legacy demo Event Ledger fixtures
-- DEV project now uses operational project data.
-- ============================================================

delete from public.event_cross_references
where event_id in (
...
delete from public.event_ai_assessments
where event_id in (
  '00000000-0000-4000-8000-000000000701',
  '00000000-0000-4000-8000-000000000702',
  '00000000-0000-4000-8000-000000000703',
...
delete from public.event_evidence
where event_id in (
  '00000000-0000-4000-8000-000000000701',
  '00000000-0000-4000-8000-000000000702',
  '00000000-0000-4000-8000-000000000703',
...
-- ============================================================
-- AXION: remove legacy demo reference corpus fixtures
-- Operational DEV projects must not retain Arena mock data.
-- ============================================================
...
delete from public.schedule_activities
where id in (

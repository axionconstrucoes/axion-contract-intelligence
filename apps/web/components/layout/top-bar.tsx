  ...
  return (
    <header className="flex h-14 shrink-0 items-center justify-between border-b border-border bg-white px-4 text-foreground shadow-sm">
      <div className="flex items-center gap-4">
        {/* Nome da marca fica só na sidebar (ver app-sidebar.tsx) — nunca
            repetido aqui, para não duplicar a mesma informação em dois
            lugares da mesma tela. Seletor/identificador do projeto
            continua o elemento principal deste cabeçalho. */}
